...
## Example
The figure below illustrates a simulation of a 2D Cauchy Storm Process with ![\alpha=1.5,\,a=1](https://latex.codecogs.com/svg.latex?\alpha=1.5,\,a=1) for a (400,600) rectangle.
